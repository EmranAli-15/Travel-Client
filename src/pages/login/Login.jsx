        ...
        <div className='max-w-7xl mx-auto'>
            <div>
                <div className="flex flex-col md:flex-row justify-between h-full items-center min-h-screen sm:justify-center sm:pt-0">
                    ...
                    <div className="w-full md:w-1/2 px-6 py-4 md:mt-6 border-b-[5px] border-b-[#4ed8c1] overflow-hidden bg-white shadow-2xl  sm:max-w-lg sm:rounded-lg">
                        ...
                        <div className="mt-10 flex flex-col md:flex-row items-center justify-center">
                            ...
                            <span>
                                <Link to='/signup'><p className="text-pink font-bold hover:underline hover:text-blue-500 ms-2">
                                    REGISTER
                                </p></Link>
                            </span>
                        </div>
