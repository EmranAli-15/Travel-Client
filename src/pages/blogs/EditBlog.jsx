...
const EditForm = ({ getBlog }) => {
    ...
    return (
        <div>
            <h1 className='text-3xl font-bold text-center underline mb-5'>Update Your Blog</h1>
            ...
            <div className='grid grid-cols-2 max-w-[500px] mx-auto'>
                {
                    img.map((img, index) => <div key={index} className='h-[200px] w-[200px] relative'>
            ...
            <button onClick={() => handleUpdate()} className='allBtn w-full flex justify-center' type='submit'>Update</button>
